...
class GoogleAssistantContextAggregator(OpenAIAssistantContextAggregator):
    ...
    async def handle_aggregation(self, aggregation: str):
        ...
        """
        # Record the index where the textual assistant message will be added so
        # that we can potentially reorder any function-call messages that
        # belong to the same LLM response _after_ that text.
